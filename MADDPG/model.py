...
class Critic(nn.Module):
    ...
    def __init__(self, merge, full_state_size, full_action_size, seed, fc1_units, fc2_units, fc3_units):
        """Initialize parameters and build model.
        Params
        ======
            seed (int): Random seed
    ...
    def forward(self, states, actions):
        ...
        actions=actions.contiguous().view(actions.shape[0],-1)
        if self.merge==False:    #tried leaky_relu/relu,batchnorm,merge=False or True nothing worked!
